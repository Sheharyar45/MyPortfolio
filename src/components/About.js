    ...
    <div className="bg-black md:h-auto h-auto cover-full  w-full   items-center gap-10 justify-between text-white flex flex-row flex-wrap">
      <div className="md:p-32 mt-24 ml-3 md:mt-0 md:ml-0 ">
        <img
          src="/image.jpg"
          alt=""
          className="mt-4 block w-full h-36 md:h-96 object-cover rounded-full border-4 border-teal-950 shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl"
        />
